...
import PropertyCard02 from './PropertyCard02';
import { sampleProperties } from '@/data/sampleData';

export default function ThemeList02() {
  return (
      ...
      <aside className="w-full md:w-[240px] flex-shrink-0">
        <div className="bg-white border border-gray-200 rounded-lg p-5 sticky top-[88px] shadow-sm">
          ...
          <div className="mb-6 space-y-3">
            <a href="#" className="block text-[15px] font-bold text-teal cursor-pointer hover:underline">전체 매물 보기</a>
          </div>
          ...
          <div className="mb-4">
            ...
            <ul className="space-y-2.5 text-[13px] text-gray-600 pl-1">
              <li className="cursor-pointer hover:text-teal">50평 미만</li>
              <li className="cursor-pointer hover:text-teal">50평~100평</li>
              <li className="cursor-pointer hover:text-teal">100평~200평</li>
              <li className="cursor-pointer hover:text-teal">200평 이상</li>
              <li className="cursor-pointer hover:text-teal">시세이하 매물</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-[13px] text-gray-600 pl-1">
              <li className="flex items-center gap-2 cursor-pointer hover:text-teal">
                <input type="checkbox" className="accent-teal cursor-pointer" /> 1층/리테일
              </li>
              <li className="flex items-center gap-2 cursor-pointer hover:text-teal">
                <input type="checkbox" className="accent-teal cursor-pointer" /> 프라임 오피스
              </li>
              <li className="flex items-center gap-2 cursor-pointer hover:text-teal">
                <input type="checkbox" className="accent-teal cursor-pointer" /> 인테리어
              </li>
              <li className="flex items-center gap-2 cursor-pointer hover:text-teal">
                <input type="checkbox" className="accent-teal cursor-pointer" /> 통건물
              </li>
              <li className="flex items-center gap-2 cursor-pointer hover:text-teal">
                <input type="checkbox" className="accent-teal cursor-pointer" /> 지하/스튜디오
              </li>
              <li className="flex items-center gap-2 cursor-pointer hover:text-teal">
                <input type="checkbox" className="accent-teal cursor-pointer" /> 주택형 사무실
              </li>
              <li className="flex items-center gap-2 cursor-pointer hover:text-teal">
                <input type="checkbox" className="accent-teal cursor-pointer" /> 테라스
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4 mb-6 shadow-sm flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="relative w-full sm:w-[280px]">
            <input 
              ...
              className="w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded text-[14px] focus:outline-none focus:border-teal transition-colors"
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            ...
            <a href="/map" className="ml-auto sm:ml-0 text-[13px] bg-dark text-white hover:bg-teal px-4 py-2 rounded font-medium transition-colors flex items-center gap-1 text-center whitespace-nowrap">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
          {sampleProperties.map((property) => (
            <PropertyCard02 key={property.id} property={property} />
          ))}
        </div>
        ...
        <div className="flex justify-center items-center gap-2 mt-12 mb-8">
          ...
          <button className="w-8 h-8 flex items-center justify-center border border-teal bg-teal text-white rounded font-bold text-[14px]">1</button>
