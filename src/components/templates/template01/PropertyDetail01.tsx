...
export default function PropertyDetail01({ property }: PropertyDetailProps) {
              ...
              <div className="p-0 overflow-x-auto">
                <table className="w-full text-[13px] text-center whitespace-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr className="bg-[#fff9f2] font-bold text-gold border-t-2 border-gold/20">
              ...
              <div className="p-5">
                <div className="w-full aspect-[21/9] bg-gray-200 rounded mb-6 relative flex items-center justify-center overflow-hidden">
                  ...
                  <div className="w-32 h-32 bg-dark/60 rounded-full flex items-center justify-center z-10 animate-pulse border border-dark/20">
                    <div className="w-16 h-16 bg-gold/50 rounded-full"></div>
                  </div>
                ...
                <div className="border-t border-gray-100 flex">
                  <button className="flex-1 py-3 text-center border-b-2 border-gold text-gold font-bold text-[14px]">편의시설</button>
                ...
                <div className="flex justify-between items-center max-w-[500px] mx-auto mt-6">
                  {['지하철', '편의점', '카페', '은행', '관공서', '병원'].map((item) => (
                    <div key={item} className="flex flex-col items-center gap-2 cursor-pointer group">
                      <div className="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center text-gray-400 group-hover:border-gold group-hover:text-gold transition">
                        <div className="w-4 h-4 bg-gray-300 rounded-sm group-hover:bg-gold/50"></div>
                      </div>
          ...
          <div className="w-full lg:w-[32%] sticky top-[88px] space-y-4">
            ...
            <div className="bg-white border border-gray-200 rounded">
              <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
                ...
                <div className="flex items-center gap-2">
                  <button className="p-1.5 border border-gray-200 rounded text-gray-400 hover:text-gold hover:border-gold transition"><FiHeart size={16}/></button>
              ...
              <div className="p-5">
                <div className="text-[20px] font-bold text-dark mb-4 flex gap-1 items-baseline flex-wrap">
                  <span>보증금 <span className="text-gold">{property.deposit}</span></span>
                  <span className="text-gray-300 mx-1">|</span>
                  <span>월 임대료 <span className="text-gold">{property.monthlyRent}</span></span>
                </div>
            ...
            <div className="bg-white border border-gray-200 rounded">
              <div className="p-5 border-b border-gray-100 flex items-center gap-4">
                <div className="w-14 h-14 bg-gold/10 rounded-full flex items-center justify-center text-gold font-black text-xl shrink-0">
                  G
                </div>
                <div>
                  <p className="text-[12px] font-bold text-gray-500 mb-0.5">매물문의 및 상담</p>
                  <p className="font-bold text-[15px] text-dark">부동산컨설팅부 <span className="text-gold">02-6959-1946</span></p>
              ...
              <div className="p-5">
                <input 
                  type="text" 
                  placeholder="연락처" 
                  className="w-full border border-gray-300 rounded px-3 py-2.5 text-[14px] mb-3 focus:outline-none focus:border-gold"
                />
                <textarea 
                  placeholder="문의 사항을 남겨주세요"
                  rows={3}
                  className="w-full border border-gray-300 rounded px-3 py-2.5 text-[14px] mb-3 focus:outline-none focus:border-gold resize-none"
                ></textarea>
                ...
                <button className="w-full bg-gold hover:bg-gold/90 text-white font-bold py-3.5 rounded text-[15px] transition-colors shadow-[0_4px_10px_rgba(212,175,55,0.3)]">
                  상담신청하기
                </button>
              </div>
            </div>
